...
var Document = createReactClass({
    ...
    uploadDocument: function(){
        ...
        localStorage.setItem('passport',"good")
        
        const data = new FormData()
            data.append('File', this.state.imagesave)
        
 
        axios.post('https://akachi-task-manager-api.herokuapp.com/passport', data).then((res)=>{
            
           
            
            localStorage.setItem("Passport", res.data)
            ...
            localStorage.setItem('passport',"bad")
        }
